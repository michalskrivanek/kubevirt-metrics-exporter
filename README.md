...
| `--health-listen-address` | `HEALTH_LISTEN_ADDRESS` | _(empty)_ | Plain HTTP address for health checks; Kubernetes and OpenShift deployments use `:8081` while metrics use `:8080` and `:8443`, respectively |
